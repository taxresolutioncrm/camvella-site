...
import { response, enforcePublicRateLimit, appCorsConfig } from '../_shared/server.ts';

export default {
  fetch: withSupabase({ auth:'none', cors:appCorsConfig(), errors:{detailed:false} }, async(req,ctx)=>{
